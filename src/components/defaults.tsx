...
export const defaults = {
    ...
    //Loader
    //Materials
    lineBasicMaterial: { parameters: () => new LineBasicMaterial() },
    lineDashedMaterial: { parameters: () => new LineDashedMaterial() },
    meshBasicMaterial: { parameters: () => new MeshBasicMaterial() },
    meshDepthMaterial: { parameters: () => new MeshDepthMaterial() },
    meshDistanceMaterial: { parameters: () => new MeshDistanceMaterial() },
    meshLambertMaterial: { parameters: () => new MeshLambertMaterial() },
    meshMatcapMaterial: { parameters: () => new MeshMatcapMaterial() },
    meshNormalMaterial: { parameters: () => new MeshNormalMaterial() },
    meshPhongMaterial: { parameters: () => new MeshPhongMaterial() },
    meshPhysicalMaterial: { parameters: () => new MeshPhysicalMaterial() },
    meshStandardMaterial: { parameters: () => new MeshStandardMaterial() },
    meshToonMaterial: { parameters: () => new MeshToonMaterial() },
    pointsMaterial: { parameters: () => new PointsMaterial() },
    rawShaderMaterial: { parameters: () => new RawShaderMaterial() },
    shaderMaterial: { parameters: () => new ShaderMaterial() },
    shadowMaterial: { parameters: () => new ShadowMaterial() },
    spriteMaterial: { parameters: () => new SpriteMaterial() },
    ...
    frustum: { p0: () => new Plane(), p1: () => new Plane(), p2: () => new Plane(), p3: () => new Plane(), p4: () => new Plane(), p5: () => new Plane(), },
    interpolant: {},
    line3: { start: () => new Vector3(0, 0, 0), end: () => new Vector3(0, 0, 0), },
    mathUtils: {},
    matrix3: {},
    matrix4: {},
    plane: { normal: new Vector3(1, 0, 0), constant: 0 },
    quaternion: {},
    ray: { origin: () => new Vector3(0, 0, 0), direction: () => new Vector3(0, 0, -1) },
    sphere: { center: () => new Vector3(0, 0, 0), radius: -1 },
    spherical: { radius: 1, phi: 0, theta: 0 },
    sphericalHarmonics3: {},
    triangle: { a: () => new Vector3(0, 0, 0), b: () => new Vector3(0, 0, 0), c: () => new Vector3(0, 0, 0) },
    vector2: { x: 0, y: 0 },
    vector3: { x: 0, y: 0, z: 0 },
    ...
    dataArrayTexture: {
        ...
        type: THREE.UnsignedByteType, rotation: 0, center: () => new Vector2(0, 0), generateMipmaps: true, premultiplyAlpha: false, flipY: true,
