...
/**
 * Port of webgl_loader_texture_ktx2 from Three.js examples.
 * Demonstrates KTX2 (Basis Universal) texture loading.
 *
 * Source: https://threejs.org/examples/webgl_loader_texture_ktx2.html
 */

export const LoaderTextureKtx2 = () => {
    ...
    return (
        <canvas3D>
            ...
            <scene background={new THREE.Color(0xffffff)}>
                ...
                {[-300, 0, 300].map((x, i) => (
                    <mesh key={`low-${i}`} position={[x, -150, 0]} ref={(el) => { if (el) meshesRef()[3 + i] = el }}>
                        <boxGeometry args={[200, 200, 200]} />
...
export default LoaderTextureKtx2