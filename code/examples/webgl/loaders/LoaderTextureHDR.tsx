...
/**
 * Port of webgl_loader_texture_hdr from Three.js examples.
 * Demonstrates HDR (Radiance) texture loading.
 *
 * Source: https://threejs.org/examples/webgl_loader_texture_hdr.html
 */

export const LoaderTextureHdr = () => {
    const exposure = $(2.0)
...
export default LoaderTextureHdr