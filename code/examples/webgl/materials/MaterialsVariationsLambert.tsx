...
/**
 * Port of webgl_materials_variations_lambert from Three.js examples.
 * Demonstrates MeshLambertMaterial with various color combinations.
 *
 * Source: https://threejs.org/examples/webgl_materials_variations_lambert.html
 */
                ...
                {materialVariations.map((mat, i) => {
                    ...
                    return (
                        ...
                        >
                            ...
                            <meshLambertMaterial color={mat.color} />
                        </mesh>
                    )
                })}
            </scene>
