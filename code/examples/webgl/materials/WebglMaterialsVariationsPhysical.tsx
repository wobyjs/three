...
export const WebglMaterialsVariationsPhysical = () => {
                ...
                <group ref={groupRef}>
                    {Array.from({ length: 5 }).map((_, i) => (
                        <mesh key={i} position={[i * 1.5 - 3, 0, 0]}>
                            ...
                            <meshPhysicalMaterial color={0xe67e22} metalness={0.5} roughness={0.3} />
                        </mesh>
                    ))}
                </group>
            </scene>
...
export default WebglMaterialsVariationsPhysical