...
export const WebglEffectsAnaglyph = () => {
    ...
    useEffect(() => {
        ...
        const effect = new THREE.AnaglyphEffect(renderer, width, height)
...
export default WebglEffectsAnaglyph
