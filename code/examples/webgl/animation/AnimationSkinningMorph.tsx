 ...
 * Key features: morph targets, expressive robot, animation states/emotes
...
export const AnimationSkinningMorph = () => {
    ...
    useEffect(() => {
        ...
        gltfLoader.load(
            ...
            (gltf) => {
                ...
                const face = gltf.scene.getObjectByName('Head_4')
                if (face) faceRef(face)
    ...
    const fadeToAction = (name: string, duration: number) => {
        ...
        const previousAction = $$(activeActionRef)
