...
import { Color, OBJExporter } from 'three'
 ...
 * Demonstrates OBJ export functionality.
 *
 * Source: https://threejs.org/examples/misc_exporter_obj.html
 *
 * Key features:
 * - OBJExporter for mesh export
 * - Material export
 * - Multiple object export
 */

export const ExporterOBJ = () => {
    ...
    return (
        <canvas3D>
            ...
            {/* Export button */}
            <mesh position={[0, 3, 0]} onClick={exportOBJ}>
