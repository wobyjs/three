...
declare global {
    interface Window {
        __$$objParams$$__: objParams
    }
}

if (!window.__$$objParams$$__)
    //@ts-ignore
    window.__$$objParams$$__ = {}

export const objParams: objParams = window.__$$objParams$$__
...
//  */
// //@ts-ignore
//objParams.webglMultipleRenderTargets = [...objParams.webglRenderTarget,
// ].distinct()
...
// //@ts-ignore
// consParams.webglAttributes = [
//     'gl',
// ].distinct()

// //D:\Developments\FengShui\meta-suyen\packages\woby-three\node_modules\@types\three\src\renderers\webgl\WebGlAttributes.d.ts
// //@ts-ignore
// objParams.webglAttributes = [
// ].distinct()

// //D:\Developments\FengShui\meta-suyen\packages\woby-three\node_modules\@types\three\src\renderers\webgl\WebGlBindingStates.d.ts
// //@ts-ignore
// consParams.webglBindingStates = [
//     'gl',
//     'attributes',
// ].distinct()
...
// //@ts-ignore
// consParams.bitangentNode = [
//     'scope',
// ].distinct()

// //D:\Developments\FengShui\meta-suyen\packages\woby-three\node_modules\@types\three\examples\jsm\nodes\accessors\BitangentNode.d.ts
// //@ts-ignore
//objParams.bitangentNode = [...objParams.node,
//     'scope',
// ].distinct()

// //D:\Developments\FengShui\meta-suyen\packages\woby-three\node_modules\@types\three\examples\jsm\nodes\accessors\CameraNode.d.ts
// //@ts-ignore
// consParams.cameraNode = [
//     'scope',
// ].distinct()

// //D:\Developments\FengShui\meta-suyen\packages\woby-three\node_modules\@types\three\examples\jsm\nodes\accessors\CameraNode.d.ts
// //@ts-ignore
//objParams.cameraNode = [...objParams.object3dNode,
// ].distinct()

// //D:\Developments\FengShui\meta-suyen\packages\woby-three\node_modules\@types\three\examples\jsm\nodes\accessors\MaterialNode.d.ts
// //@ts-ignore
// consParams.materialNode = [
//     'scope',
// ].distinct()

// //D:\Developments\FengShui\meta-suyen\packages\woby-three\node_modules\@types\three\examples\jsm\nodes\accessors\MaterialNode.d.ts
// //@ts-ignore
//objParams.materialNode = [...objParams.node,
//     'scope',
// ].distinct()
...
// //@ts-ignore
// consParams.normalNode = [
//     'scope',
// ].distinct()

// //D:\Developments\FengShui\meta-suyen\packages\woby-three\node_modules\@types\three\examples\jsm\nodes\accessors\NormalNode.d.ts
// //@ts-ignore
//objParams.normalNode = [...objParams.node,
//     'scope',
// ].distinct()

// //D:\Developments\FengShui\meta-suyen\packages\woby-three\node_modules\@types\three\examples\jsm\nodes\accessors\PositionNode.d.ts
// //@ts-ignore
// consParams.positionNode = [
//     'scope',
// ].distinct()

// //D:\Developments\FengShui\meta-suyen\packages\woby-three\node_modules\@types\three\examples\jsm\nodes\accessors\PositionNode.d.ts
// //@ts-ignore
//objParams.positionNode = [...objParams.node,
//     'scope',
// ].distinct()

// //D:\Developments\FengShui\meta-suyen\packages\woby-three\node_modules\@types\three\examples\jsm\nodes\accessors\ReflectVectorNode.d.ts
// //@ts-ignore
// consParams.reflectVectorNode = [
// ].distinct()

// //D:\Developments\FengShui\meta-suyen\packages\woby-three\node_modules\@types\three\examples\jsm\nodes\accessors\ReflectVectorNode.d.ts
// //@ts-ignore
//objParams.reflectVectorNode = [...objParams.node,
// ].distinct()

// //D:\Developments\FengShui\meta-suyen\packages\woby-three\node_modules\@types\three\examples\jsm\nodes\accessors\TangentNode.d.ts
// //@ts-ignore
// consParams.tangentNode = [
//     'scope',
// ].distinct()

// //D:\Developments\FengShui\meta-suyen\packages\woby-three\node_modules\@types\three\examples\jsm\nodes\accessors\TangentNode.d.ts
// //@ts-ignore
//objParams.tangentNode = [...objParams.node,
//     'scope',
// ].distinct()
...
// //D:\Developments\FengShui\meta-suyen\packages\woby-three\node_modules\@types\three\examples\jsm\nodes\accessors\UvNode.d.ts
// //@ts-ignore
//objParams.uvNode = [...objParams.attributeNode,
//     'isUvNode',
//     'index',
// ].distinct()
...
// //@ts-ignore
// consParams.rapierPhysicsObject = [
//     'addScene',
//     'addMesh',
//     'setMeshPosition',
//     'setMeshVelocity',
...
// //@ts-ignore
// consParams.slotNode  = // consParams.slotNodeParameters

// //D:\Developments\FengShui\meta-suyen\packages\woby-three\node_modules\@types\three\examples\jsm\renderers\webgl\nodes\SlotNode.d.ts
// //@ts-ignore
// objParams.slotNodeParameters = [
//     'node',
//     'nodeType',
//     'source',
//     'target',
...
// //@ts-ignore
//objParams.slotNode = [...objParams.node,
//     'inclusionType',
//     'node',
//     'source',
//     'target',
...
// //@ts-ignore
// consParams.bokehShaderUniforms = [
//     'textureWidth',
//     'textureHeight',
//     'focalDepth',
//     'focalLength',
...
// //@ts-ignore
// consParams.arButtonSessionInit = [
//     'domOverlay',
// ].distinct()

// //D:\Developments\FengShui\meta-suyen\packages\woby-three\node_modules\@types\three\examples\jsm\webxr\ARButton.d.ts
// //@ts-ignore
// objParams.arButtonSessionInit = [
//     'domOverlay',
// ].distinct()
